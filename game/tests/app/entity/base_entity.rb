...
def test_base_entity_place_in_game_map(args, assert)
...
def test_base_entity_place_in_inventory(args, assert)
  TestHelper.init_globals(args)
  entity = build_entity
  actor = build_actor
...
def test_base_entity_parent_inventory_from_data(args, assert)
  TestHelper.init_globals(args)
  actor = build_actor
  entity = build_item
